...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Thumbs Down Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

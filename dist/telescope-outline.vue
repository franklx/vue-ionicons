...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Telescope Outline Icon"
    return {
      iconTitle: iconTitle
    }
  }

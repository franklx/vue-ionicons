...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Musical Notes Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

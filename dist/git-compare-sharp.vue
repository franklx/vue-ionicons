...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Git Compare Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Documents Outline Icon"
    return {
      iconTitle: iconTitle
    }
  }

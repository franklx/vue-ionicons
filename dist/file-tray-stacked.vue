...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "File Tray Stacked Icon"
    return {
      iconTitle: iconTitle
    }
  }

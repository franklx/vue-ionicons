...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Battery Charging Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

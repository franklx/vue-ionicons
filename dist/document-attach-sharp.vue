...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Document Attach Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Extension Puzzle Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

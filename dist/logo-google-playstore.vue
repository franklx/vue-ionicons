...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Logo Google Playstore Icon"
    return {
      iconTitle: iconTitle
    }
  }

...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "American Football Icon"
    return {
      iconTitle: iconTitle
    }
  }

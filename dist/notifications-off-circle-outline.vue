...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Notifications Off Circle Outline Icon"
    return {
      iconTitle: iconTitle
    }
  }

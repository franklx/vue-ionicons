...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Help Circle Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }

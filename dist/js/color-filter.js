(function (global, factory) {
  ...
  var script = {
    ...
    data: function data() {
      var iconTitle = this.title ? this.title : "Color Filter Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var colorFilter = normalizeComponent_1(

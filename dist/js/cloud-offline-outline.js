(function (global, factory) {
  ...
  var script = {
    ...
    data: function data() {
      var iconTitle = this.title ? this.title : "Cloud Offline Outline Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var cloudOfflineOutline = normalizeComponent_1(

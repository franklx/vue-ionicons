(function (global, factory) {
  ...
  var script = {
    ...
    data: function data() {
      var iconTitle = this.title ? this.title : "Beer Icon";
      return {
        iconTitle: iconTitle
      };
    }

(function (global, factory) {
  ...
  var script = {
    ...
    data: function data() {
      var iconTitle = this.title ? this.title : "Wine Icon";
      return {
        iconTitle: iconTitle
      };
    }

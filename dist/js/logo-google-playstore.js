(function (global, factory) {
  ...
  var script = {
    ...
    data: function data() {
      var iconTitle = this.title ? this.title : "Logo Google Playstore Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var logoGooglePlaystore = normalizeComponent_1(

...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Mail Unread Sharp Icon"
    return {
      iconTitle: iconTitle
    }
  }
